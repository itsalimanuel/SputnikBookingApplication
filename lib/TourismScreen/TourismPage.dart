...
import 'package:sputnikgroup/TourismScreen/detalisPage.dart';
        ...
        children: <Widget>[
          Column(
            ...
            children: <Widget>[
              ...
              Padding(
                padding: const EdgeInsets.only(left: 18.0),
                child: Text('Was the USSR communist? From the Perestroika',
              ...
              Padding(
                padding: const EdgeInsets.only(left: 18.0),
                child: Text('Russia went to a capitalism, which today faces the Lenin Mausoleum with the main luxury brands of the GUM ',
                    style: TextStyle(color: Colors.grey, fontSize: 14.0)),
              ),
              SizedBox(
                height: 2.0,
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ListView(
                    ...
                    children: <Widget>[
                      cardItemWidget(context, "1.jpg",
                          'Musee du Louvre', '10 BOKING'),
                      Padding(
                        padding: EdgeInsets.only(left: 12.0),
                      ),
                      cardItemWidget(context, "2.jpg",
                          'Arc de Triomphe', '63 BOKING'),
                      Padding(
                        padding: EdgeInsets.only(left: 12.0),
                      ),
                      cardItemWidget(context, "3.jpg",
                          'Musee du Louvre', '10 BOKING'),
                      Padding(
